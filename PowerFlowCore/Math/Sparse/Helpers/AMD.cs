...
namespace PowerFlowCore.Algebra
{
    internal static class AMD
    {
        ...
        /// <summary>
        /// Create symbolic CSC matrix
        /// </summary>
        /// <param name="A"></param>
        /// <param name="order"></param>
        private static SymbolicCSCMatrix ConstructMatrix(SymbolicCSCMatrix A, int order)
        {
            SymbolicCSCMatrix result = null;
            ...
            if (order == 1)
            {
                if (n != m)
                {
                    throw new ArgumentException("Inp", "A");
                }
