...
namespace PowerFlowCore.Algebra
{
    internal static class GraphHelper
    {
        ...
        /// </summary>
        public static int[] ColumnCounts(SymbolicCSCMatrix A, int[] parent, int[] post, bool ata)
        {
        ...
        /// </summary>
        public static int EtreeReach(SymbolicCSCMatrix A, int k, int[] parent, int[] s, int[] w)
        {
            int i, p, n, len;
